...
import static com.coresmash.tiles.TileContainer.getOppositeSide;

/**
 * Created by Michail on 18/3/2018.
 */

public class Tilemap extends com.coresmash.Observable implements Comparable<Tilemap> {
    private int groupID;
    ...
    public Vector3 getWorldToTilemapCoords(Vector3 world) {
        ...
        int tileSize = com.coresmash.WorldSettings.getTileSize();
    ...
    private void updateTilemapTile(TilemapTile tmTile) {
        float x = tmTile.getX();
        float y = tmTile.getY();
        float tileSize = com.coresmash.WorldSettings.getTileSize();
