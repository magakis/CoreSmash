        ...
        dlgConfirmDelete = new Dialog("", skin) {
            ...
            protected void result(Object object) {
                if ((boolean) object) {
                    ...
                    file.delete();
                    Array<com.coresmash.levelbuilder.LevelListParser.RegisteredLevel> tmp = levelList.getItems();
                    tmp.removeValue(chosen, false);
                    levelList.setItems(tmp);
                    if (chosen.num != 0) {
                        levelListParser.serializeLevelList(tmp);
                    }
                    com.coresmash.ui.Components.showToast("Deleted '" + chosen.name + "'", this.getStage());
                }
            }
        };
