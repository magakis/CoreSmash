...
public class TilemapManagerTest extends com.coresmash.tests.ProjectTestCase {
    com.coresmash.tilemap.TilemapManager tilemapManager;
    ...
    public void testWorldPosition() {
        com.coresmash.tilemap.TilemapBuilder builder = tilemapManager.newLayer();
        com.coresmash.Coords2D def = tilemapManager.getDefTilemapPosition();
