...
final public class LevelBuilder {
    ...
    private List<com.coresmash.levelbuilder.MapSettings> mapSettings;
    ...
    LevelBuilder(OrthographicCamera cam) {
        ...
        map.newLayer();
        mapSettings.add(new com.coresmash.levelbuilder.MapSettings());
    ...
    public boolean saveAs(String name) {
        ...
        return LevelParser.saveAs(name, map, levelSettings, mapSettings.toArray(new com.coresmash.levelbuilder.MapSettings[mapSettings.size()]));
    }
    ...
    public boolean load(String name) {
        ...
        for (int i = 0; i < parsedLevel.getMapCount(); ++i) {
            if (i < mapSettings.size()) {
                ...
                com.coresmash.levelbuilder.MapSettings ms = new com.coresmash.levelbuilder.MapSettings();
